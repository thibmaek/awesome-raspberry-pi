...
- [Build a SamplerBox musical instrument](http://chromakinetics.com/samplerbox) - Simple instructions to make a MIDI sampler. Requires Pi 3B and Audio Pirate hat.
