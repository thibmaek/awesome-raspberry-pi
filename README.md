...
- [*Atlas* toolkit](https://github.com/epeios-q37/atlas-python) - Very lightweight and easy to install toolkit to write in *Python* (no *JavaScript* needed) web applications to pilot your RPi, without having to install a web server.
