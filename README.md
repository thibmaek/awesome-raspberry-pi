...
- [PiGro - Just Click It!](https://github.com/actionschnitzel/PiGro-Aid-) - Everything you need to use the Pi as a desktop computer. PiGro does many commands that have to be entered via the terminal with one or two clicks of a button.
