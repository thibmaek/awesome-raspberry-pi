...
- [SimOnPi](https://github.com/M0Rf30/simonpi) - A quick & dirty script to emulate Raspberry family devices on your laptop. It generates a valid sdcard image that can be deployed on real hardware and used as virtual storage for QEMU. Automatic network access. Docker assets available.
