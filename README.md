...
- [BunkerWeb](https://www.bunkerweb.io) - Open-source, secure-by-default Web Application Firewall (WAF) based on NGINX with a web UI and easy integration (Docker, Kubernetes, etc.).
