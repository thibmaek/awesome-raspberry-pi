...
- [PiFi (AP + Client)](https://github.com/cjimti/iotwifi) - 8MB [Docker Container](https://hub.docker.com/r/cjimti/iotwifi/) with REST API for controlling wifi client and station modes simultaneously. ![Supports Raspberry Pi 3](/media/badges/rpi-3.png)
