...
- [PiSpot-Show](https://github.com/GeiserX/PiSpot-Show) - Battery-powered WiFi voucher display system using PiJuice HAT, generating dynamic 1080p HDMI images with weather integration for hospitality venues. Includes 3D-printable enclosure and Ansible deployment.
